...
module.exports.LMTPServer = require('./lmtp-server').LMTPServer;
...
function SMTPServer(options) {
    ...
    this.options.announceEnhancedStatus = this.options.announceEnhancedStatus || false;
    ...
    this.server = (this.options.secure ? tls : net).createServer(this.options, function (socket) {
        var connection = this._createConnection(socket);
...
SMTPServer.prototype._createConnection = function(socket){
